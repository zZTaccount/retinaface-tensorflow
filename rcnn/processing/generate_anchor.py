...
def generate_anchors(base_size=16, ratios=[0.5, 1, 2],
    ...
    # print('generate_anchors config: ratio={},scales={},stride={}\n'.format(ratios,scales,stride))
    if dense_anchor:
      assert stride%2==0
      anchors2 = anchors.copy()
      anchors2[:,:] += int(stride/2)
      anchors = np.vstack( (anchors, anchors2) )
    # print('generate_anchors: anchor.shape={}, anchors={}'.format(anchors.shape, anchors))
    return anchors
...
#anchors = generate_anchors(dense_anchor=True)
#print (anchors)
